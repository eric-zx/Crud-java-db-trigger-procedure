...
public class FormAlterarVendedor extends JFrame {
    ...
    private void initComponents() {
        JLabel jLabel1 = new JLabel("Digite a matrícula a ser pesquisada:");
        ...
        jBpesquisar.addActionListener(evt -> {
            try {
                v.setMatricula(jTpesquisar.getText());
                dao.pesquisarRegistro(v);
                jTnome.setText(v.getNome());
                jTsetor.setText(v.getSetor());
                jTpesquisar.setEnabled(false);
            } catch (Exception ex) {
                Logger.getLogger(FormAlterarVendedor.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "Erro ao pesquisar vendedor.");
            }
        });
        ...
        jBalterar.addActionListener(evt -> {
            try {
                ...
                v.setSetor(jTsetor.getText());
                dao.editarVendedor(v);
                ...
                Logger.getLogger(FormAlterarVendedor.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "Erro ao alterar vendedor.");
            }
        });
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> new FormAlterarVendedor().setVisible(true));
    }
}
